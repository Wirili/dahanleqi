...
@section('content')
    ...
    <div class="pull-right mb5">
        <a class="btn btn-primary" href="{{URL::route('admin.article_cat.create')}}">@lang('article.cat.add')</a>
    </div>
    <table id="dt" class="table table-bordered table-striped table-hover">
        ...
        <td>
        <a data-toggle="tooltip" data-placement="bottom" title="@lang('sys.edit')" href="{{URL::route('admin.article_cat.edit',['id'=>$item['cat_id']])}}"><i class="fa fa-edit"></i></a>
        <a class="text-danger" data-toggle="tooltip" data-placement="bottom" title="@lang('sys.del')" href="{{URL::route('admin.article_cat.del',['id'=>$item['cat_id']])}}"><i class="fa fa-remove"></i></a>
        </td>
        </tr>
        @endforeach
        </tbody>
